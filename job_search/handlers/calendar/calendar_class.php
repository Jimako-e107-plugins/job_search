...
class DHTML_Calendar
{
	...
	function __construct($stripped = true)
	{
		if ($stripped)
		{
			$this->calendar_file = e_PLUGIN . 'job_search/handlers/calendar/calendar_stripped.js';
			$this->calendar_setup_file = e_PLUGIN . 'job_search/handlers/calendar/calendar-setup_stripped.js';
		}
		else
		{
			$this->calendar_file = e_PLUGIN . 'job_search/handlers/calendar/calendar.js';
			$this->calendar_setup_file = e_PLUGIN . 'job_search/handlers/calendar/calendar-setup.js';
		}


		if(file_exists(e_PLUGIN . 'job_search/handlers/calendar/language/'.e_LANGUAGE.'.js'))
		{
			$this->calendar_lang_file = e_PLUGIN . 'job_search/handlers/calendar/language/'.e_LANGUAGE.'.js';
		}
		else
		{
			$this->calendar_lang_file = e_PLUGIN . 'job_search/handlers/calendar/language/English.js';
		}
		...
		{
			$this->calendar_img = "<img style='vertical-align:middle; border:0px' src='".e_PLUGIN . "job_search/handlers/calendar/cal.gif'  alt='' />";
		}
		...
		{
			$this->calendar_theme_file = e_PLUGIN . "job_search/handlers/calendar/calendar.css";
		}
